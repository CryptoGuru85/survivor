...
class PasswordChange extends PureComponent<Props, State> {
  constructor(props) {
    super(props);
    this.state = {
      password: undefined,
          ...
          <div className="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div className="d-flex align-items-center flex-wrap mr-1">
              <div className="d-flex align-items-baseline flex-wrap mr-5">
                <h5 className="text-dark font-weight-bold my-1 mr-5">Cambio password</h5>
              </div>
            </div>
          </div>
        </div>
  ...
  validateAndSubmit() {
    ...
    if (isPasswordValid)
      Request.api("POST", "/api/user/newpassword",
        {
