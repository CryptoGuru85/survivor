...
const confirmationcode = makeid(30);
...
let transporter = nodemailer.createTransport({
    ...
    auth: {
      type: 'OAuth2',
      user: 'survivorfanta@gmail.com',
      pass: 'Bologna90',
      clientId: '602790904103-j73ds2idskhdquufv7mjrtl1v7vh2r8c.apps.googleusercontent.com',
      clientSecret: '9D6naj-Qvo245l4s-IdpWQgD',
      refreshToken: '1//04hnNyq5uZO-ZCgYIARAAGAQSNwF-L9Ir4QAsuvXlM181Pf39OCXYqfPoYxSv-T70E5i1twbssAJklRBaybXK4XFCaofsY7k3hs0'
    }
  });
  ...
  let mailOptions = {
    ...
    to: "pluplus19@gmail.com",
    subject: 'Survivor - conferma mail',
    html: `
    <!DOCTYPE html>
              ...
              style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                ...
                <tr>
                  <td style="padding:30px;background-color:#ffffff;">
                    ...
                    <p style="margin:0;">
                    Conferma la registrazione alla piattaforma, entra nella comunity di Survivor Game e partecipa ai concorsi a premio e leghe pubbliche e private.
                    <br>
                    Clicca sul bottone per confermare la registrazione
                    </p>
                  </td>
                </tr>
                <tr>
                  ...
                  border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                    ...
                    font-size:16px;line-height:22px;color:#363636;">
                      <p style="margin:0;">
                      <a href="`+ url +`/Confirmemail?mail=` + mail + `&id=` + confirmationcode + `" 
